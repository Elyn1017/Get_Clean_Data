...
========================================================
 ...
 Run_Analysis.R
-------------------- 
 This script loads the data in test and training and does the following:
        1. merges both train and test dataset
        2.extract the mean and standard deviation for each variable.
        3. Label the data and the activities.
        4. Creates a tidy dataset containing only the mean of the measurements 
         for each subject and activity.
        
Codebook
-------------------- 
        The finaldataset(tidydata) has the following columns:
        "Subject"  : The Id of each of the subject ,
        "Activity" : The activity done by each subject. They could  be:
                1       WALKING
                2       WALKING_UPSTAIRS
        ...
        And the rest of the variables are the mean of each characteristic by subject and activity:
        "tBodyAcc_mean_X"
        "tBodyAcc_mean_Y"
        "tBodyAcc_mean_Z"
        "tBodyAcc_std_X"
